...
The `SpheroidPy` package has been developed for python 3.10.9 and has been tested under Windows and macOS.
Before you can start using the package, you need to install it using one of the following methods.


Install using pip
-----------------

The package is available on `pypi <https://pypi.org/project/SpheroidPy/>`_, so you should be
...
Install from source
-------------------
Installing from source can be necessary if the `pypi <https://pypi.org/project/SpheroidPy/>`_ installation does not work
or if the latest source code should be installed from `github <https://github.com/CedHe/SpheroidPy>`_.
...
`SpheroidPy` to function properly.
...
If ... the ai model detectron2 needs to be installed.

The following packages should be installed to use some miscellaneous features:


Downloading `SpheroidPy`
""""""""""""""""""""

The package can be simply checked out from
`github.com/CedHe/SpheroidPy <https://github.com/CedHe/SpheroidPy>`_.
...
The main aim of the :mod:`SpheroidPy` package is to simulate partial differential
